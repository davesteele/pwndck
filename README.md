...
# Usage
    ...
    $ pwndck.py -h
    usage: __main__.py [-h] [-q] [-i [INPUT] | passwords ...]
    ...
    Evaluate one or more passwords against the HaveIBeenPwned password database, and
    return the number of accounts for which they have been reported as compromised.
    ...
    If the password is not specified on the command line, and there is no std input,
